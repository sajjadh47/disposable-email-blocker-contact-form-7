<?php
/**
 * This file contains the definition of the Disposable_Email_Blocker_Contact_Form_7_Deactivator class, which
 ...
 * @since    2.0.0
 */
class Disposable_Email_Blocker_Contact_Form_7_Deactivator {
	/**
	 * Deactivation hook.
	 *
